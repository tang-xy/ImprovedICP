...
class ImprovedICP:
    ...
    def __init__(self, iface):
        ...
        self.toolbar = self.iface.addToolBar(u'ImprovedICP')
        self.toolbar.setObjectName(u'ImprovedICP')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ImprovedICP', message)
